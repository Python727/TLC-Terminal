  ...
  _render() {
    ...
    this.shadowRoot.innerHTML = `
      ...
      <div class="panel">
        ...
        <div class="keys">
          ${rows}
          <div class="key-row"><kbd>Colors</kbd>${t('legend.colors')}</div>
        </div>
        
        <div class="keys">
          <div class="key-row"><kbd>LMB</kbd> ${t('legend.lmb')}</div>
          <div class="key-row"><kbd>MMB</kbd> ${t('legend.mmb')}</div>
          <div class="key-row"><kbd>E</kbd>&nbsp;&nbsp;&nbsp; ${t('legend.e')}</div>
          <div class="key-row"><kbd>RMB</kbd> ${t('legend.rmb')}</div>
          <div class="key-row"><kbd>Scroll</kbd> ${t('legend.scroll')}</div>
        </div>
      </div>
    `;
  }
