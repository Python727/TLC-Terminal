...
const LOCATION_TYPES = {
  ...
  SharkBay: { color:'#c92d06', size:'sm', icon:'Indicator_SharkBay',      label:'Shark Bay'},
  RollerBoi: { color:'#049217', size:'sm', icon:'Indicator_RollerBoiFactory',      label:'Roller Boi Factory'},
  StarChild: { color:'#5a007e', size:'sm', icon:'Indicator_StarChild',      label:'Star Child'},
};
...
function _loc(raw, zone, hidden) {
  return {
     ...
     *      icon: 'Indicator_SolarPanel',             // URL zu einem benutzerdefinierten Symbol (optional)
...
const _r = [
  ...
  
  {
    ...
    defaults: {
      notes:   ['1x Electric Engine (Booster).', '1x Diesel Engine (Booster).'],
      resources: [      
        {label: 'Lumimid',    value: '3x'},
      ],
    },
    enemies: [
      { category:'Hazards',       name:'Sentinel Mine', count:  2},
      { category:'Small Enemies', name:'Sweetheart',    count:  9},
      { category:'Small Enemies', name:'Pink Slime',    count:  2},
      { category:'Small Enemies', name:'Red Slime',     count:  2},
    ],
  },
  
  {
    ...
    defaults: {
      resources: [      
        {label: 'Lumimid',    value: '6x'},
        {label: 'Cyclone',    value: '6x'},
        {label: 'Recykler',    value: '2x'},
        {label: 'Fabricator',    value: '2x'},
        {label: 'Water Purifier',    value: '1x'},
        {label: 'Food Processor',    value: '1x'},
        {label: 'Water Pump',    value: '4x'},
        {label: 'Lazarus Rack',    value: '4x'},
      ],
    },
    enemies: [
      { category:'Hazards',       name:'Sentinel Mine', count:  8},
      { category:'Small Enemies', name:'Sweetheart',    count:  20},
      { category:'Small Enemies', name:'Mosquito',      count:  4},
      { category:'Small Enemies', name:'Green Crawler', count:  6},
      { category:'Small Enemies', name:'Night Crawler', count:  9},
      { category:'Small Enemies', name:'Pink Slime',    count:  4},
      { category:'Small Enemies', name:'Red Slime',     count:  2},
      { category:'Large Enemies', name:'Angel',         count:  4},
    ],
  },
  
  {
    ...
    enemies: [
      { category:'Small Enemies', name:'Night Crawler', count:  19},
    ],
  },
  
  {
    ...
    defaults: {
      resources: [      
        {label: 'Diesel Tank',    value: '4x'},
      ],
      tanks: { 
        diesel:  { count: 4, current: 350 },   
      },
    },
    enemies: [
      { category:'Small Enemies', name:'Green Crawler', count:  14},
    ],
  },
  
  {
    ...
    defaults: {
      notes:   ['9 Seed available.'],
    },
    enemies: [
      { category:'Hazards',       name:'Sentinel Mine', count:  8},
      { category:'Small Enemies', name:'Night Crawler', count:  26},
      { category:'Small Enemies', name:'Red Slime',     count:  13},
      { category:'Large Enemies', name:'Angel',         count:  2},
    ],
  },
  
  {
    ...
    defaults: {
      resources: [      
        {label: 'Lumimid',    value: '5x'},
        {label: 'Cyclone',    value: '4x'},
      ],
    },
    enemies: [
      { category:'Hazards',       name:'Sentinel Mine', count:  2},
  ...
  
  {
    ...
    defaults: {
      resources: [
        {label: 'Diesel Tank',    value: '4x'},
        {label: 'Petrol Tank',    value: '4x'},
      ],
      
      tanks: {  
        diesel:  { count: 4, current: 425 },   
        petrol:  { count: 4, current: 425 },  
      },
    },
    enemies: [
      { category:'Small Enemies', name:'Mosquito',      count:  6},
      { category:'Small Enemies', name:'Pink Slime',    count:  2},
    ],
  },
  
  {
    ...
    defaults: {
      resources: [      
        {label: 'Oil Tank',    value: '2x'},
        {label: 'Diesel Tank',    value: '2x'},
        {label: 'Petrol Tank',    value: '2x'},
        {label: 'Oil Pump',    value: '1x'},
      ],
      tanks: { 
        oil:     { count: 2, current: 400},  
        diesel:  { count: 2, current:  528},   
        petrol:  { count: 2, current: 1250},  
      },
    },
    enemies: [
      { category:'Hazards',       name:'Sentinel Mine', count:  10},
      { category:'Small Enemies', name:'Mosquito',      count:  14},
      { category:'Small Enemies', name:'Green Crawler', count:  13},
      { category:'Small Enemies', name:'Pink Slime',    count:  9},
      { category:'Small Enemies', name:'Red Slime',     count:  7},
      { category:'Large Enemies', name:'Arch Angel',    count:  2},
    ],
  },
  ...
  
  {
    ...
    defaults: {
      resources: [      
        {label: 'Lumimax',    value: '2x'},
        {label: 'Typhoon',    value: '2x'},
        {label: 'Water Pump',    value: '4x'},
        {label: 'Oil Tank',    value: '2x'},
        {label: 'Methane Tank',    value: '1x'},
        {label: 'Oxygen Tank',    value: '1x'},
        {label: 'Sabatier Reactor',    value: '1x'},
      ],
      tanks: { 
        oil:     { count: 2, current: 415 },   
        oxygen:  { count: 1, current: 2250 },   
        methane: { count: 1, current: 1 },   
      },
    },
    enemies: [
      { category:'Hazards',       name:'Sentinel Mine', count:  15},
      { category:'Small Enemies', name:'Sweetheart',    count:  20},
      { category:'Small Enemies', name:'Green Crawler', count:  9},
      { category:'Small Enemies', name:'Night Crawler', count:  24},
      { category:'Small Enemies', name:'Pink Slime',    count:  7},
      { category:'Small Enemies', name:'Red Slime',     count:  2},
      { category:'Large Enemies', name:'Roller Boi',    count:  3},
      { category:'Large Enemies', name:'Laser Bob',     count:  1},
      { category:'Large Enemies', name:'Angel',         count:  4},
    ],
  },
  
  {
    ...
    defaults: {
      resources: [      
        {label: 'Oxygen Tank',    value: '2x'}, 
      ],
      tanks: { 
        oxygen:  { count: 2, current: 3150 },    
      },
    },
    enemies: [
      { category:'Hazards',       name:'Sentinel Mine', count:  10},
      { category:'Small Enemies', name:'Pink Slime',    count:  3},
      { category:'Large Enemies', name:'Roller Boi',    count:  4},
      { category:'Large Enemies', name:'Laser Bob',     count:  1},
      { category:'Large Enemies', name:'Talon Shark',   count:  1},
      { category:'Large Enemies', name:'Angel',         count:  4},
    ],
  },
  
  {
    ...
    enemies: [
      { category:'Small Enemies', name:'Sweetheart',    count:  7},
      { category:'Small Enemies', name:'Pink Slime',    count:  3},
      { category:'Small Enemies', name:'Red Slime',     count:  4},
      { category:'Large Enemies', name:'Roller Boi',    count:  2},
    ],
  },
  
  {
    ...
    enemies: [
      { category:'Hazards',       name:'Sentinel Mine', count:  1},
      { category:'Small Enemies', name:'Green Crawler', count:  8},
      { category:'Small Enemies', name:'Pink Slime',    count:  4},
      { category:'Small Enemies', name:'Red Slime',     count:  5},
      { category:'Large Enemies', name:'Talon Shark',   count:  1},
    ],
  },
  ...
  
  {
    ...
    enemies: [
      { category:'Hazards',       name:'Sentinel Mine', count:  5},
      { category:'Small Enemies', name:'Green Crawler', count:  7},
      { category:'Small Enemies', name:'Pink Slime',    count:  3},
      { category:'Small Enemies', name:'Red Slime',     count:  2},
    ],
  },
  
  {
    ...
    defaults: {
      ...
      tanks: {  
        oxygen:  { count: 2, current: 4022 },
      },
    },
    enemies: [
      { category:'Hazards',       name:'Sentinel Mine', count:  8},
      { category:'Small Enemies', name:'Mosquito',      count:  8},
      { category:'Small Enemies', name:'Night Crawler', count:  3},
      { category:'Small Enemies', name:'Pink Slime',    count:  3},
      { category:'Small Enemies', name:'Red Slime',     count:  4},
    ],
  },
  
  {
    ...
    defaults: {
      resources: [      
        {label: 'Diesel Tank',    value: '2x'},
        {label: 'Patrol Tank',    value: '2x'},
      ],
      tanks: { 
        diesel:  { count: 2, current: 491 },   
        petrol:  { count: 2, current: 200 },  
      },
    },
    enemies: [
      { category:'Small Enemies', name:'Mosquito',      count:  13},
      { category:'Small Enemies', name:'Pink Slime',    count:  7},
      { category:'Small Enemies', name:'Red Slime',     count:  3},
      { category:'Large Enemies', name:'Roller Boi',    count:  2},
    ],
  },
  
  {
    ...
    enemies: [
      { category:'Small Enemies', name:'Green Crawler', count:  16},
      { category:'Small Enemies', name:'Pink Slime',    count:  6},
      { category:'Small Enemies', name:'Red Slime',     count:  4},
    ],
  },
  
  {
    ...
    defaults: {
      notes:   ['Hostile environment with many resources.', 'Some Containers are filled with Monsters.'],
      resources: [      
        {label: 'Mega Recycler',    value: '1x'},
      ],
    },
    enemies: [
      { category:'Hazards',       name:'Sentinel Mine', count:  20},
      { category:'Small Enemies', name:'Sweetheart',    count:  3},
      { category:'Small Enemies', name:'Mosquito',      count:  9},
      { category:'Small Enemies', name:'Green Crawler', count:  28},
      { category:'Small Enemies', name:'Night Crawler', count:  "At Nighttime"},
      { category:'Small Enemies', name:'Pink Slime',    count:  6},
      { category:'Small Enemies', name:'Red Slime',     count:  6},
      { category:'Large Enemies', name:'Roller Boi',    count:  4},
      { category:'Large Enemies', name:'Laser Bob',     count:  1},
      { category:'Large Enemies', name:'Arch Angel',    count:  3},
    ],
  },
  
  {
    ...
    defaults: {
      resources: [      
        {label: 'Lumimax',    value: '2x'},
        {label: 'Whisper',    value: '2x'},
        {label: 'Diesel Tank',    value: '4x'},
      ],
      tanks: { 
        diesel:  { count: 4, current: 593 },   
      },
    },
    enemies: [
      { category:'Small Enemies', name:'Sweetheart',    count:  1},
      { category:'Small Enemies', name:'Mosquito',      count:  6},
      { category:'Small Enemies', name:'Night Crawler', count:  7},
      { category:'Large Enemies', name:'Roller Boi',    count:  1},
      { category:'Large Enemies', name:'Angel',         count:  2},
    ],
  },
  ...
  
  {
    ...
    defaults: {
      resources: [      
        {label: 'Lumimid',    value: '8x'},
        {label: 'Cyclone',    value: '9x'},
      ],
    },
    enemies: [
      { category:'Small Enemies', name:'Sweetheart',    count:  13},
      { category:'Small Enemies', name:'Night Crawler', count:  6},
      { category:'Large Enemies', name:'Roller Boi',    count:  2},
    ],
  },
  ...
  
  {
    ...
    defaults: {
      ...
      tanks: { 
        diesel:  { count: 4, current: 577 },   
        petrol:  { count: 4, current: 195 },  
      },
    },
    enemies: [
      { category:'Small Enemies', name:'Mosquito',      count:  12},
    ],
  },
  ...
  
  {
    ...
    enemies: [
      { category:'Hazards',       name:'Sentinel Mine', count:  6},
      { category:'Small Enemies', name:'Sweetheart',    count:  14},
      { category:'Large Enemies', name:'Roller Boi',    count:  1},
    ],
  },
  ...
  
  {
    ...
    enemies: [
      { category:'Small Enemies', name:'Mosquito',      count:  4},
      { category:'Small Enemies', name:'Pink Slime',    count:  3},
      { category:'Small Enemies', name:'Red Slime',     count:  1},
    ],
  },
...

  {
    ...
    enemies: [
      { category:'Hazards',       name:'Sentinel Mine', count:  12},
      { category:'Small Enemies', name:'Green Crawler', count:  13},
      { category:'Small Enemies', name:'Pink Slime',    count:  2},
      { category:'Small Enemies', name:'Red Slime',     count:  2},
    ],
  ...
  
  {
    ...
    defaults: {
      resources: [      
        {label: 'Lumimid',    value: '5x'},
        {label: 'Cyclone',    value: '2x'},
      ],
    },
    enemies: [
      { category:'Hazards',       name:'Sentinel Mine', count:  4},
      { category:'Small Enemies', name:'Sweetheart',    count:  8},
      { category:'Large Enemies', name:'Roller Boi',    count:  1},
    ],
  },
  
  {
    ...
    defaults: {
      notes:   [
        'This is an Save Point.',
        'Take your time to explore the area and gather resources.',
        'Maybe rebuild your tanks and prepare for the next areas.'
      ],
      resources: [      
        {label: 'Battery',    value: '3x'},
        {label: 'Lumimid',    value: '4x'},
        {label: 'Cyclone',    value: '3x'},
        {label: 'Diesel Tank',    value: '2x'},
        {label: 'Fabricator',    value: '2x'},
        {label: 'Recycler',    value: '2x'},
      ],
      tanks: { 
        battery: { count: 3, current: 3900 },
        diesel:  { count: 2, current: 4000 },   
      },
    },
    enemies: [
      { category:'Small Enemies', name:'Sweetheart',    count:  8},
      { category:'Small Enemies', name:'Mosquito',      count:  10},
      { category:'Small Enemies', name:'Green Crawler', count:  5},
      { category:'Small Enemies', name:'Night Crawler', count:  12},
      { category:'Small Enemies', name:'Pink Slime',    count:  6},
      { category:'Small Enemies', name:'Red Slime',     count:  6},
      { category:'Large Enemies', name:'Roller Boi',    count:  1},
      { category:'Large Enemies', name:'Arch Angel',    count:  2},
  ...
  
  {
    ...
    enemies: [
      { category:'Small Enemies', name:'Mosquito',      count:  5},
      { category:'Large Enemies', name:'Roller Boi',    count:  1},
    ],
  },
...

  {
    ...
    enemies: [
      { category:'Small Enemies', name:'Green Crawler', count:  1},
      { category:'Large Enemies', name:'Roller Boi',    count:  1},
    ],
  },
...

  {
    ...
    gameid:'SharkbBay',    
    info:[
      "This is a bay for sharks.",
      "Trident Sharks Are Here",
      "Talon Sharks are Here",
      "Dorsal Shark are Here"
    ],
    defaults: {
      notes:   [
        'Collect 4 Trident Sharks => Bay 1',
        'Collect 2 Talon Sharks => Bay 2',
        'Collect 1 Dorsal Sharks => Bay 3'
      ],
    },
    enemies: [
      { category:'Hazards', name:'Sentinel Mine', count:  6},
      { category:'Small Enemies', name:'Sweetheart',    count:  11},
      { category:'Small Enemies', name:'Mosquito',      count:  3},
      { category:'Small Enemies', name:'Night Crawler', count:  45},
      { category:'Small Enemies', name:'Pink Slime',    count:  5},
      { category:'Large Enemies', name:'Trident Shark',    count:  2},
      { category:'Large Enemies', name:'Talon Shark',    count:  1},
      { category:'Large Enemies', name:'Dorsal Shark',    count:  1},
    ],
  },

  {
    name:'Talon Offshore Providing Deck',       
    longitude:96,  
    latitude:58,  
    type:'RollerBoi',        
    gameid:'RollerBoiFactory',    
    info:"Roller Boy Providing Deck => F.E.L.I.S Unit",
    defaults: {
      notes:   [
        'Get Your Privat F.E.L.I.S Unit',
      ],
    },
    enemies: [
      { category:'Small Enemies', name:'Sweetheart',    count:  5},
      { category:'Small Enemies', name:'Mosquito',      count:  11},
      { category:'Small Enemies', name:'Green Crawler', count:  16},
      { category:'Large Enemies', name:'Roller Boi',    count:  2},
    ],
  },
...
const _h = [
  ...
  
  {
    ...
    enemies: [
      { category:'Hazards',       name:'Sentinel Mine', count:  9},
      { category:'Large Enemies', name:'Laser Bob',     count:  1},
      { category:'Large Enemies', name:'Arch Angel',    count:  2},
    ],
  },
  ...
  
  {
    ...
    info:[
      "Quarantine Stack Amen is a quarantine stack",
      'The "Rust Tag" paint can can be found here',
      'The "Ammonite" paint can be found here',
      '"Power Triode 336" can be Scanned here'
    ],
    enemies: [
      { category:'Small Enemies', name:'Sweetheart',    count:  1},
      { category:'Small Enemies', name:'Mosquito',      count:  22},
      { category:'Small Enemies', name:'Night Crawler', count:  5},
      { category:'Large Enemies', name:'Laser Bob',     count:  1},
      { category:'Large Enemies', name:'Talon Shark',   count:  1},
    ],
  },
  
  {
    ...
    info:[
      "Quarantine Stack Aurora is a quarantine stack",
      'The "Rust Tag" paint can can be found here',
      'The "Leaf Wall" paint can be found here',
      '"Power Triode 268" can be Scanned here'
    ],
    enemies: [
      { category:'Small Enemies', name:'Mosquito',      count:  4},
    ],
  ...
  
  {
    ...
    info:[
      "Quarantine Stack Chorus is a quarantine stack",
      'The "Rust Tag" paint can can be found here',
      'The "Leaf Wall" paint can be found here',
      '"Power Triode 108" can be Scanned here'
    ],
    enemies: [
      { category:'Small Enemies', name:'Mosquito',      count:  3},
    ],
  ...
  
  {
    ...
    info:[
      "Quarantine Stack Dawn is a quarantine stack",
      'The "Rust Tag" paint can can be found here',
      'The "Leaf Wall" paint can be found here',
      '"Power Triode 437" can be Scanned here'
    ],
    enemies: [
      { category:'Small Enemies', name:'Mosquito',      count:  5},
      { category:'Large Enemies', name:'Roller Boi',    count:  2},
  ...
  {
    name:'Unnamed Rocky Spire',   
    longitude:182, 
    latitude:-38, 
    type:'RockySpire', 
    gameid:'nogameid',    
    info:["Unnamed Rocky Spire is a mysterious location"],
  },

  {
    name:'Courier Sieve Node Facility',       
    longitude:169,  
    latitude:-1,  
    type:'StarChild',        
    gameid:'StarChildA',    
    ...
    enemies: [
      { category:'Large Enemies', name:'Arch Angel',    count:  4},
      { category:'Large Enemies', name:'Talon Shark',    count:  3},
      { category:'Large Enemies', name:'Trident Shark',    count:  4},
      { category:'Large Enemies', name:'Dorsal Shark',    count:  1},
    ],
